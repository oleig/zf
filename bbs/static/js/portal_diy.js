...
drag.extend({
	'getBlocksTimer' : '',
	'blocks' : [],
	'blockDefaultClass' : [{'key':'选择样式','value':''},{'key':'样式1','value':'xbs_1'},{'key':'样式2','value':'xbs xbs_2'},{'key':'样式3','value':'xbs xbs_3'},{'key':'样式4','value':'xbs xbs_4'},{'key':'样式5','value':'xbs xbs_5'},{'key':'样式6','value':'xbs xbs_6'},{'key':'样式7','value':'xbs xbs_7'}],
	'frameDefaultClass' : [{'key':'选择样式','value':''},{'key':'无边框框架','value':'xfs xfs_nbd'},{'key':'样式1','value':'xfs xfs_1'},{'key':'样式2','value':'xfs xfs_2'},{'key':'样式3','value':'xfs xfs_3'},{'key':'样式4','value':'xfs xfs_4'},{'key':'样式5','value':'xfs xfs_5'}],
	...
	openStyleEdit : function (e) {
		...
		table += '<tr><th>字体</th><td><input type="text" id="fontsize" class="px p_fre" value="'+fontsize+'" size="2" /> px <input type="text" id="fontcolor" class="px p_fre" value="'+fontcolor+'" size="2" />';
		table += getColorPalette(id+'_fontPalette', 'fontcolor' ,fontcolor)+'</td></tr>';
		table += '<tr><th>链接</th><td><input type="text" id="linkfontsize" class="px p_fre" value="'+linkfontsize+'" size="2" /> px <input type="text" id="linkcolor" class="px p_fre" value="'+linkcolor+'" size="2" />';
		...
		table += ' 颜色<input type="text" id="bdtcolor" class="px p_fre" value="'+bdtcolor+'" size="7" />';
		...
		table += ' 颜色<input type="text" id="bdrcolor" class="px p_fre" value="'+bdrcolor+'" size="7" />';
		...
		table += ' 颜色<input type="text" id="bdbcolor" class="px p_fre" value="'+bdbcolor+'" size="7" />';
		...
		table += ' 颜色<input type="text" id="bdlcolor" class="px p_fre" value="'+bdlcolor+'" size="7" />';
		...
		table += '<tr><th>外边距</th><td><div id="margindiv" class="'+ulclass+'"><span><label>上</label><input type="text" id="margint" class="px p_fre" value="'+margint+'" size="1"/>px </span>';
		...
		table += '<tr><th>背景颜色</th><td><input type="text" id="bgcolor" class="px p_fre" value="'+bgcolor+'" size="4" />';
		table += getColorPalette(id+'_bgcPalette', 'bgcolor' ,bgcolor)+'</td></tr>';
		table += '<tr><th>背景图片</th><td><input type="text" id="bgimage" class="px p_fre" value="'+bgimage+'" size="25" /> <select class="ps" id="bgrepeat" >'+this.getOption(repeatarr,bgrepeat)+'</select></td></tr>';
	...
	openTitleEdit : function (e) {
		...
		common += '<tr><th>背景图片:</th><td><input type="text" id="titleBgImage" class="px p_fre" value="'+bgimage+'" /> <select class="ps" id="titleBgRepeat" >'+this.getOption(repeatarr,bgrepeat)+'</select></td></tr>';
		...
		li += '&nbsp;&nbsp;颜色:<input type="text" id="titleColor_0" class="px p_fre" value="`color`" size="4" />';
