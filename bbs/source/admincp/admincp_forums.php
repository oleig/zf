 ...
 *
 *      $Id: admincp_forums.php 18909 2010-12-08 06:58:47Z liulanbo $
 */
		...
		if(count($mforum) == 1 && $mforum[0]['type'] == 'group') {
			...
			foreach($mforum as $forum) {
				...
				if(!$multiset) {
					...
					showsetting('forums_edit_basic_banner', 'bannernew', $forum['banner'], 'filetext', '', 0, $forumbannerhtml.cplang('forums_edit_basic_banner_comment'));
				}
