...
(
	...
	'attachmentlist_isimage' => '附件类型',
	'attachmentlist_isimage_comment' => '设置调用的附件类型',
	'attachmentlist_isimage_0' => '全部附件',
	'attachmentlist_isimage_1' => '图片附件',
	...
	'attachmentlist_orderby_comment' => '设置以哪一字段或方式对附件进行排序',
	'attachmentlist_orderby_dateline' => '按最后更新日期排序',
	'attachmentlist_orderby_downloads' => '按下载次数倒序排序',
	'attachmentlist_orderby_hourdownloads' => '按小时下载次数倒序排序',
	'attachmentlist_orderby_todaydownloads' => '按当天下载次数倒序排序',
	'attachmentlist_orderby_weekdownloads' => '按本周下载次数倒序排序',
	'attachmentlist_orderby_monthdownloads' => '按当月下载次数倒序排序',
