...
$lang = array (
  ...
  'group_create_notice' => '注：除{$_G[setting][navs][3][navname]}名称和分类暂时不能修改外，其它项目在创建完成后仍可修改。',
  ...
  'group_url_copy_finished' => '{$_G[setting][navs][3][navname]}地址已经复制到剪贴板',
